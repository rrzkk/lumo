export default function caterringMenu() {
  return (
    <div>
      ...
      <p>- grilled chicken, avocado, baby spinach</p>
      <p>- mixture</p>
      <br />
      ...
      <p>
        ...
        caramel w/ white chocolate & macadamia
      </p>
      <p>We can make it a platter with your choice of cookie flavour.</p>
      <br />
      <p style={{ fontWeight: "bolder" }}>
      ...
      <p>- Supreme:</p>
      <p>
        Mozzarella, halloumi, feta, tomato, basil, onions, salami, olives,
        capsicum, onions, thyme oregano, sumac
      </p>
      <p>- Ham & Pineapple:</p>
      <p>
        Mozzarella, halloumi, feta, tomato, basil, onions, ham, pineapple,
        thyme, oregano, sumac
      </p>
      <p>- Mushroom (V): mushroom, tomato, onion, basil</p>
      <p>- Vegetarian (V):</p>
      <p>
        Capsicum, onions, tomato, basil, olives, thyme, oregano, sesame, sumac
      </p>
      ...
      <p>
        ...
        nutmeg, cinnamon, and cardamom, tomato, capsicum, onions
      </p>
      <p>- Spinach & Cheese (V):</p>
      <p>
        Mozzarella, halloumi, feta, english and silverbeet spinach, sumac, lemon
        salt, lemon, black pepper, cumin, paprika, coriander, cloves, nutmeg,
