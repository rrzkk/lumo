    ...
    <main className="flex min-h-screen flex-col items-center  p-24">
      ...
      <div className="menu-main " style={{ zIndex: "500" }}>
        ...
        {isChecked && (
          <div className="foodMenu">
            <div className="basis-1/12 secTitile">All Day Breakfast</div>
            <div
              className="basis-5/12 foodSection"
              style={{ borderLeft: " 2px solid #34c759 " }}
            >
              <p style={{ fontWeight: "bold" }}>Acai Bowl (V, GF, DF, ) 17</p>
              <p>
                100% organic Acai topped with fresh seasonal fruits & berries,
                gluten free granola w/ coconut water
              </p>
              <br />
              <p style={{ fontWeight: "bold" }}>Classic Bacon & Egg Roll 13</p>
              <p>
                Grilled bacon, fried egg, hashbrown, aioli & BBQ sauce on milk
                bun
              </p>
              <br />
              ...
              <p>
                Grilled rindless bacon, mixed lettuce, crushed avocado, tomato
                w/aioli on Turkish
              </p>
              <br />
              <p style={{ fontWeight: "bold" }}>Chilli Scrambled Eggs 17.5 </p>
              <p>
                Cherry tomato, baby spinach, XO sauce, chilli oil, garnish with
                chilli flake & fresh chilli
              </p>
              <br />
              <p style={{ fontWeight: "bold" }}>Eggs Your Way 14 </p>
              <p>Two eggs as your way w/ sourdough toast</p>
              <br />
              <p style={{ fontWeight: "bold" }}>Crushed Avo Stack (V,RSF) 16</p>
              <p>
                Crushed avocado, fetta cheese, cherry tomato & rocket on lightly
                toasted turkish w/vinaigrette dressing
              </p>
              <br />
              ...
              <p>
                Grilled homemade corn fritters, poached egg, crushed avocado,
                tomato relish, tomato salsa and charred kale{" "}
              </p>
              <br />
            </div>{" "}
            <div className="basis-1/12 secTitile">Lunch</div>
            {/** Here is the Lunch Menu */}
            <div
              className="basis-5/12 foodSection"
              style={{ borderLeft: " 2px solid #34c759 " }}
            >
              <p style={{ fontWeight: "bold" }}>Chicken Halloumi Salad 18</p>
              <p>
                Grilled Chicken breast, halloumi, mesculin mix, cucumber,
                radicchio, smashed avo, corn chips, Cherry tomato with French
                dressing
              </p>
              <br />
              <p style={{ fontWeight: "bold" }}>Lets Taco ‘bout Fish 19</p>
              <p>
                Crispy hoki, mixed salad, homemade mango salsa, tartare sauce on
                flour tortillas
              </p>
              <br />
              ...
              <p>
                Crispy halloumi cheese, coleslaw, bbq sauce, sliced tomato and
                crispy onion on milk bun with steakhouse chips
              </p>
              <br />
              ...
              <br />
              <p style={{ fontWeight: "bold" }}>Southern Chicken Burger 20</p>
              <p>
                Lettuce, cucumber pickles, red pickles, cheese, chipotle mayo on
                brioche with steakhouse chips
              </p>
              <br />
              <p style={{ fontWeight: "bold" }}>Fish Burger 20</p>
              <p>
                Crispy Hoki, lettuce, cucumber pickles, tomato, siracha mayo on
                brioche with steakhouse chips
              </p>
              <br />
              ...
              <br />
              <p style={{ fontWeight: "bold" }}>Sweet potato fries 10</p>
              <p>with sour cream & sweet chilli</p>
              <br />
            </div>
          </div>
        )}
        ...
        {!isChecked && (
          <div className="foodMenu">
            ...
            <div className="basis-3/4 foodSection">{caterringMenu()}</div>{" "}
          </div>
        )}
      </div>
      ...
      {isChecked ? (
        <p style={{ fontWeight: "bolder", margin: "10px" }}>
          Toggle to Catering Menu
        </p>
      ) : (
        <p style={{ fontWeight: "bolder", margin: "10px" }}>
          Toggle to Normal Menu
        </p>
      )}
    </main>
  );
